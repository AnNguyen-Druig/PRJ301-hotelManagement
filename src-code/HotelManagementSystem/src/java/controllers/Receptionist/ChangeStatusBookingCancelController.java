 ...
 * @author Admin
 */
@WebServlet(name = "ChangeStatusBookingCancelController", urlPatterns = {"/ChangeStatusBookingCancelController"})
public class ChangeStatusBookingCancelController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (bookingID != null && !bookingID.isEmpty()
                ...
                bookingUpdateStatus = bookingDAO.updateStatusBooking(bookingID_value, "Canceled");
