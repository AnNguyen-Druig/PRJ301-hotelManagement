 ...
 * @author Admin
 */
@WebServlet(name = "ChangeStatusBookingCheckOutController", urlPatterns = {"/ChangeStatusBookingCheckOutController"})
public class ChangeStatusBookingCheckOutController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (bookingID != null && !bookingID.trim().isEmpty()
                ...
                //Gọi DAO thực hiện update status cho Booking
                bookingUpdateStatus = bookingDAO.updateStatusBooking(bookingID_value, "CheckOut");
