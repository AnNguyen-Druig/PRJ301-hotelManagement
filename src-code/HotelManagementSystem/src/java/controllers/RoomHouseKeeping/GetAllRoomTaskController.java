 ...
 * @author Nguyễn Đại
 */
@WebServlet(name="GetAllRoomTaskController", urlPatterns={"/GetAllRoomTaskController"})
public class GetAllRoomTaskController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            e.printStackTrace();
            request.setAttribute("Error", "Can't load data please check database");
            request.getRequestDispatcher("MainController?action=cleanpage").forward(request, response);
        }
    } 
