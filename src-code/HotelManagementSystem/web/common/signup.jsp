    ...
    <body>
        ...
        <div class="container">
            <form action="MainController" method="post">
                <h3>Tài Khoản</h3>
                <div class="mb-3">
                    <label for="guest_username" class="form-label">Tên đăng nhập <span class="red">*</span></label>
                    <input type="text" class="form-control" name="guest_username" required="" value="<%=username%>">
                </div>
                <div class="mb-3">
                    <label for="guest_password" class="form-label">Mật khẩu <span class="red">*</span></label>
                ...
                <div class="mb-3">
                    <label for="guest_fullname" class="form-label">Họ và tên <span class="red">*</span></label>
                    <input type="text" class="form-control" name="guest_fullname" required="" value="<%=fullname%>">
                </div>
                <div class="mb-3">
                    <label for="guest_phone" class="form-label">Số điện thoại <span class="red">*</span></label>
                ...
                <div class="mb-3">
                    <label for="guest_idnumber" class="form-label">CCCD/CMND <span class="red">*</span></label>
